...
namespace Eclipse
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            checkemail.Parameters.AddWithValue("@email_id", email.Text.Trim());
            ...
            else
            {
                con.Close();
                con.Open();
                string inscmd = "insert into Register(name,email_id,password,datetime)values(@name,@email_id,@password,@datetime)";
                ...
                try
                {
                    ...
                    con.Close();
                    SendingMail(email.Text, "artistateclipse@gmail.com", "#1!?&eclipse", "You Are Registered", name.Text);
        ...
        public string SendingMail(string mailTo, string from, string pass, string subject, string body)
        {
            ...
            if (mailTo != "")
            {
                ...
                try
                {
                    ...
                    mail.From = new MailAddress("artistateclipse@gmail.com");
                    ...
                    emailBody += "<div style='clear:both;width:100%;text-align:center;'>&nbsp;&nbsp;&nbsp;Eclipse Art</div>";
                    emailBody += "</div>";
                    emailBody += "</div>";
                    emailBody += "</td>";
                    emailBody += "</tr>";
                    ...
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;padding-top:15px;line-height:22px;margin:0px;font-weight:bold;padding-bottom:5px'>Dear " + name.Text + ",</p>";
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:22px;color:rgb(41,41,41)'>Your User ID is: " + email.Text + "</p>";
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:22px;color:rgb(41,41,41)'>Your Password ID is: " + password.Text + "</p>";
                    emailBody += "<p>&nbsp;</p><p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:22px;margin:0px'>If you have any additional queries, please feel free to reach out us at +91 0000000111 or drop us an email at <a href='isunitiwith20@gmail.com' style='text-decoration:none;font-style:normal;font-variant:normal;font-weight:normal;font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:normal;color:rgb(162,49,35)' target='_blank'>isunitiwith20@gmail.com</a>. We are there to help you.</p>";
                    emailBody += "<p>&nbsp;</p>";
                    ...
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;color:rgb(41,41,41);line-height:22px;margin:0px'>Team Eclipse</p>";
                    emailBody += "</td>";
                    emailBody += "</tr>";
                    emailBody += "</tbody>";
                    emailBody += "</table>";
                    ...
                    Label1.Text = "You are successfully registered to our website. Welcome to Eclipse Art official site.";
                    Label1.ForeColor = System.Drawing.Color.Red;
                }
                catch (Exception ex)
                {
